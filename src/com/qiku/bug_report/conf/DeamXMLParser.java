...
import com.qiku.bug_report.conf.bean.EntryAttach;
import com.qiku.bug_report.conf.bean.EntryVariableParser;
import com.qiku.bug_report.conf.bean.ExecAttach;
import com.qiku.bug_report.conf.bean.ExecVariableParser;
import com.qiku.bug_report.conf.bean.FileAttach;
import com.qiku.bug_report.conf.bean.FileVariableParser;
import com.qiku.bug_report.conf.bean.Scenario;
import com.qiku.bug_report.conf.bean.Deam.Tag;
import com.qiku.bug_report.conf.bean.Scenario.Actions;
import com.qiku.bug_report.conf.bean.Scenario.Filter;
import com.qiku.bug_report.conf.bean.Scenario.Parser;
import com.qiku.bug_report.conf.bean.Scenario.Actions.Attach;
import com.qiku.bug_report.conf.bean.Scenario.Actions.Attach.Size;
import com.qiku.bug_report.conf.bean.Scenario.Actions.Attach.Size.Priority;
import com.qiku.bug_report.conf.bean.Scenario.Filter.Entry;
import com.qiku.bug_report.conf.bean.Scenario.Filter.Exec;
